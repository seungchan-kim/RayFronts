...
class Ros2Subscriber(PosedRgbdDataset):
  ...
  def __iter__(self):
    while True:
      ...
      # Previously, we used the Spirit drone and applied a fixed pitch offset
      # because the camera was mounted with a downward tilt.
      # That setup is now deprecated, and Pegasus is used for the code release.
      # if True:
      #   pitch = 0.1745
